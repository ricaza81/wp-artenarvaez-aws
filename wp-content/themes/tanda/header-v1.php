        ...
        <div class="container-fluid">
            <div class="row align-center">
                <div class="col-lg-6 info">
                    <ul>
                        <li>
                            <i class="<?php echo esc_attr($tanda_options['t_icon1']); ?>"></i> <?php echo esc_html($tanda_options['t_text1']); ?>
                        </li>
                        <li>
                            <i class="<?php echo esc_attr($tanda_options['t_icon2']); ?>"></i> <?php echo esc_html($tanda_options['t_text2']); ?>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-6 text-right item-flex">
                    <div class="info">
                        <ul>
                            <li>
                                <i class="<?php echo esc_attr($tanda_options['t_icon3']); ?>"></i> <?php echo esc_html($tanda_options['t_text3']); ?>
                            </li>
                        </ul>
                    </div>
                    <div class="social">
                        <ul>
                            <li>
                                <a target="_blank" href="<?php echo esc_url($tanda_options['sl1']); ?>">
                                    <i class="<?php echo esc_attr($tanda_options['sicon1']); ?>"></i>
                                </a>
                            </li>
                            <li>
                                <a target="_blank" href="<?php echo esc_url($tanda_options['sl2']); ?>">
                                    <i class="<?php echo esc_attr($tanda_options['sicon2']); ?>"></i>
                                </a>
                            </li>
                            <li>
                                <a target="_blank" href="<?php echo esc_url($tanda_options['sl3']); ?>">
                                    <i class="<?php echo esc_attr($tanda_options['sicon3']); ?>"></i>
                                </a>
                            </li>
                        </ul>
                    </div>
        ...
        <nav class="navbar navbar-default active-border navbar-sticky bootsnav">
            ...
            <div class="container-fluid">
                ...
                <div class="attr-nav inc-border">
                    <ul>
                        <li class="contact">
                            <i class="<?php echo esc_attr($tanda_options['h_icon1']); ?>"></i> 
